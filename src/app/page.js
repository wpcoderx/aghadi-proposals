  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)] transition-colors">
      ...
      <section className="relative h-screen w-full flex items-center justify-center bg-gradient-to-br from-indigo-900 to-purple-800 overflow-hidden">
        <div className="absolute inset-0 opacity-20 bg-cover animate-pulse"></div>
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-4xl">
          ...
          <div className="bottom-1 w-full animate-bounce">
      ...
      <section id="problem" className="bg-[var(--bg)] text-[var(--text)] py-20 px-4 md:px-8">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <Image
              src="/images/Business-failure-bro.svg"
      ...
      <section id="solution" className="bg-white py-20 px-4 md:px-8 relative">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
          <Image
              src="/images/Problem-solving-pana-1.svg"
